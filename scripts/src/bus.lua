...
if BUSES["A2BUS"] then
	files {
		...
		MAME_DIR .. "src/devices/bus/a2bus/sweetalk.cpp",
		MAME_DIR .. "src/devices/bus/a2bus/sweetalk.h",
...
if BUSES["ABCBUS"] then
	files {
		...
		MAME_DIR .. "src/devices/bus/abcbus/abc1656.cpp",
		MAME_DIR .. "src/devices/bus/abcbus/abc1656.h",
		...
		MAME_DIR .. "src/devices/bus/abcbus/db4105.cpp",
		MAME_DIR .. "src/devices/bus/abcbus/db4105.h",
...
if BUSES["BBC_ANALOGUE"] then
	files {
		...
		MAME_DIR .. "src/devices/bus/bbc/analogue/lightpen.cpp",
		MAME_DIR .. "src/devices/bus/bbc/analogue/lightpen.h",
		MAME_DIR .. "src/devices/bus/bbc/analogue/micromike.cpp",
		MAME_DIR .. "src/devices/bus/bbc/analogue/micromike.h",
...
if BUSES["CBMIEC"] then
	files {
		...
		MAME_DIR .. "src/devices/bus/cbmiec/dolphindos.cpp",
		MAME_DIR .. "src/devices/bus/cbmiec/dolphindos.h",
		...
		MAME_DIR .. "src/devices/bus/cbmiec/minichief.cpp",
		...
		MAME_DIR .. "src/devices/bus/cbmiec/turbotrans.h",
...
if BUSES["ISA"] then
	files {
		...
		MAME_DIR .. "src/devices/bus/isa/pcat512me.h",
		MAME_DIR .. "src/devices/bus/isa/pcmidi.cpp",
		MAME_DIR .. "src/devices/bus/isa/pcmidi.h",
		MAME_DIR .. "src/devices/bus/isa/pd32.cpp",
		MAME_DIR .. "src/devices/bus/isa/pd32.h",
...
if BUSES["PC98_CBUS"] then
	files {
		...
		MAME_DIR .. "src/devices/bus/pc98_cbus/pcfxga.h",
...
if BUSES["PCI"] then
	files {
		...
		MAME_DIR .. "src/devices/bus/pci/clgd543x_alpine.cpp",
		MAME_DIR .. "src/devices/bus/pci/clgd543x_alpine.h",
...
if BUSES["RS232"] then
	files {
		MAME_DIR .. "src/devices/bus/rs232/adm3a.cpp",
		MAME_DIR .. "src/devices/bus/rs232/adm3a.h",
...
if BUSES["S100"] then
	files {
		...
		MAME_DIR .. "src/devices/bus/s100/cromemco16kpr.cpp",
		MAME_DIR .. "src/devices/bus/s100/cromemco16kpr.h",
		MAME_DIR .. "src/devices/bus/s100/cromemco4fdc.cpp",
		MAME_DIR .. "src/devices/bus/s100/cromemco4fdc.h",
		MAME_DIR .. "src/devices/bus/s100/cromemcoram.cpp",
		MAME_DIR .. "src/devices/bus/s100/cromemcoram.h",
		MAME_DIR .. "src/devices/bus/s100/cromemcotuart.cpp",
		MAME_DIR .. "src/devices/bus/s100/cromemcotuart.h",
